#
# Be sure to run `pod lib lint VHSlideoutController.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/VHSlideoutController.git", :tag => s.version.to_s }
  ...
  s.resource_bundles = {
    'VHSlideoutController' => ['Pod/Assets/*.png']
  }
